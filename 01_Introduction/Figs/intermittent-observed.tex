\begin{figure}[htbp!]
    ...
    \begin{tikzpicture}[x=0.9pt,y=0.9pt,yscale=-1,xscale=1]
        ...
        %\draw [-] (0,100) node [anchor=north west][inner sep=0.75pt] [align=left] {\textsf{A}};
    ...
    \end{tikzpicture}
    \caption[Example of interval censoring with intermittently-observed data for an underlying process]{Example of interval censoring with intermittently-observed data for an underlying process.}\label{fig:intermittent-data}
\end{figure}